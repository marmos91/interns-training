...
describe('Server', () =>
{
    ...
    {
        let socket_spy: sinon.SinonSpy<any, dgram.Socket> = sandbox.spy(dgram.Socket.prototype, 'on');
    ...
    it('should correctly dispatch messages', (done) =>
    {
        ...
        let send_spy: sinon.SinonSpy<any, void> = sandbox.spy(dgram.Socket.prototype, 'send');
