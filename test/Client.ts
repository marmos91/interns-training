...
describe('Client', () =>
{
    ...
    {
        let dgram_stub: sinon.SinonStub <any, void> = sandbox.stub(dgram.Socket.prototype, 'send').yields(null, 10);
    ...
    {
        let socket_stub: sinon.SinonSpy<any, dgram.Socket> = sandbox.spy(dgram.Socket.prototype, 'on');
